...
if (isset($_POST['registro'])) {
    ...
    $insertarDatos = "INSERT INTO cliente (nombre_CL, apellido_CL, correo, num_celular, num_documento, 
        ...
        '$apellido_CL', '$correo', '$num_celular', '$num_documento', '$fecha_nacimiento', '$contrasena', '$id_tipo_documento', '$id_tipo_usuario', '$id_tipo_metodo')";
    ...
    if (mysqli_num_rows($verificar_num_doc) > 0) {
        echo
        '<script>
                    alert("Este documento ya fue registrado por u   n usuario, si es tu documento, inicia sesion con los datos correspondientes");
                    window.location.href = "../registrarse.php";
                </script>';
